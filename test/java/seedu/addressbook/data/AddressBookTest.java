...
public class AddressBookTest {
    ...
    @Test
    public void getAllPersonsAlphabetical() throws Exception {
        UniquePersonList allPersonsAlpha = defaultAddressBook.getAllPersonsAlphabetical();
        UniquePersonList personsToCheck = new UniquePersonList(aliceBetsy, bobChaplin);

        assertTrue(isIdentical(allPersonsAlpha, personsToCheck));
    }
}
