...
public class ParserTest {
    ...
    @Test
    public void parse_mistypedCommand_parsedCorrectly() {
        parse_closestCommandExists_parsedCorrectly();
        parse_noClosestCommand_parsedCorrectly();
    }

    private void parse_closestCommandExists_parsedCorrectly() {
        parseAndAssertCommandType("viewll", PromptCommand.class);
        parseAndAssertCommandType("adv", PromptCommand.class);
    }

    private void parse_noClosestCommand_parsedCorrectly() {
        parseAndAssertCommandType("ahdefe", HelpCommand.class);
    }
