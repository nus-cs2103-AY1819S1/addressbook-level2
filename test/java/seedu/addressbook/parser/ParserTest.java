...
public class ParserTest {
    ...
    /*
     * Tests for tag person command ==============================================================================
     */

    @Test
    public void parse_tagCommandNoArgs_errorMessage() {
        final String[] inputs = { "tag", "tag " };
        final String resultMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, TagCommand.MESSAGE_USAGE);
        parseAndAssertIncorrectWithMessage(resultMessage, inputs);
    }
