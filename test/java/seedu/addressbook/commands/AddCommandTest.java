...
public class AddCommandTest {
    ...
    public void addCommand_invalidName_throwsException() {
        ...
        for (String name : invalidNames) {
            assertConstructingInvalidAddCmdThrowsException(name, Phone.EXAMPLE, true, Email.EXAMPLE, false,
                    Block.EXAMPLE, Street.EXAMPLE, Unit.EXAMPLE, PostalCode.EXAMPLE, true, EMPTY_STRING_SET);
        }
    }
    ...
    public void addCommand_invalidPhone_throwsException() {
        ...
        for (String number : invalidNumbers) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, number, false, Email.EXAMPLE, true,
                Block.EXAMPLE, Street.EXAMPLE, Unit.EXAMPLE, PostalCode.EXAMPLE, false, EMPTY_STRING_SET);
        }
    }
    ...
    public void addCommand_invalidAddress_throwsException() {
        ...
        for (String address : invalidAddresses) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE,
                    true, address, Street.EXAMPLE, Unit.EXAMPLE, PostalCode.EXAMPLE, true, EMPTY_STRING_SET);
        }
    }
     ...
     */
    private void assertConstructingInvalidAddCmdThrowsException(
            String name,
            String phone, boolean isPhonePrivate,
            String email, boolean isEmailPrivate,
            String block, String street, String unit, String postalCode, boolean isAddressPrivate,
            Set<String> tags) {
        try {
            new AddCommand(
                    name,
                    ...
                    block, street, unit, postalCode, isAddressPrivate,
                    tags);
    ...
    public void addCommand_validData_correctlyConstructed() throws Exception {
        AddCommand command = new AddCommand(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE,
            false, Block.EXAMPLE, Street.EXAMPLE, Unit.EXAMPLE, PostalCode.EXAMPLE, true,
            EMPTY_STRING_SET);
