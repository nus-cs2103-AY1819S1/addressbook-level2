...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX_WITH_CONTEXT = "Index %1$d: The person index provided is invalid";
    public static final String MESSAGE_PERSON_NOT_IN_ADDRESSBOOK = "Person could not be found in address book";
    public static final String MESSAGE_PERSON_NOT_IN_ADDRESSBOOK_WITH_CONTEXT = "Index %1$d: Person could not be found in address book";
