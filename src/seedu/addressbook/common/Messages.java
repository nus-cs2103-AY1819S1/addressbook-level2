...
public class Messages {
    ...
    public static final String MESSAGE_SAVE_CONTACT = "Addressbook saved successfully";
    public static final String MESSAGE_SAVE_FAILED = "Failed to save addressbook";
}
