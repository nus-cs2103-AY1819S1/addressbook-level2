...
public class UniquePersonList implements Iterable<Person> {
     ...
     * Returns an unmodifiable java List view with elements cast as immutable {@link ReadOnlyPerson}s.
     * For use with other methods/libraries.
     * Any changes to the internal list/elements are not immediately visible in the returned list.
     */
    public List<ReadOnlyPerson> immutableSortedListView() {
        List<Person> internalListCopy = new ArrayList<>(internalList);
        internalListCopy.sort(Comparator.comparing(Person::getName));
