...
public class UniquePersonList implements Iterable<Person> {
     ...
     */
    public ArrayList<ReadOnlyPerson> sort() {
        ArrayList<ReadOnlyPerson> sortedPersonList = new ArrayList<>(internalList);
        sortedPersonList.sort(new Comparator<ReadOnlyPerson>() {
            @Override
