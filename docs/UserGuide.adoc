...
== Deleting all persons containing any keyword in their name: `deleteAll`

Deletes the specified person from the address book. Irreversible. +
Format: `deleteAll KEYWORD [MORE_KEYWORDS]`

****
Deleting all persons containing any keyword in their name.
****

Examples:

* `deleteAll Doe` +
Deletes all persons with names containing Doe.
