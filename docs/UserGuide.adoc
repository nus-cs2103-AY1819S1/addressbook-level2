...
== Searching for a person via their phone number: `search`

Searches for a person whose phone number matches the keyword. +
Format: `search 98374820`

Examples: 
* `search 91583820` +
Returns the contact information that has this phone number. 
