...
== Swapping index of 2 person: 'swap'

Swap the index of 2 person in the address book. +
Format: 'swap [INDEX OF FIRST TARGET] [INDEX OF SECOND TARGET]'

****
Index refers to the index number shown in most recent listing.
****
