...
== Finding all persons with tags contained in specified keywords: `findtag`
...
* `findtag nus` +
Returns all persons with tag `nus`.

* `findtag nus friends colleagues` +
Returns all persons with tag `nus` or `friends` or `colleagues`.
