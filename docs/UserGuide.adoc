...
Finds persons who have tags contained in any of the given keywords. +
Format: `tag KEYWORD [MORE_KEYWORDS]`

[NOTE]
====
The search is not case sensitive, the order of the keywords does not matter,
and persons matching at least one keyword will be returned (i.e. `OR` search).
====
...
* `tag friends` +
Returns people with tag 'friends' or 'Friends' or any other case variation

* `tag friends family` +
Returns people with tag 'friends', 'family', or both, in any case variation.
