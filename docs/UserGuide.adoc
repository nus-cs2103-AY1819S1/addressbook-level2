...
== Statistics for address book : `stats`

Shows only the total number of Persons in the address book quickly without having to go through the verbose output of  `list`. +
Format: `stats`
