...
== Sorted listing of all persons : `sort`

Shows a sorted list(by name) of all persons, along with their non-private details, in the address book. +
Format: `sort`

[NOTE]
====
This command does not overwrite the ordering of persons in the addressbook (i.e addressbook will keep the unsorted order) 
====
