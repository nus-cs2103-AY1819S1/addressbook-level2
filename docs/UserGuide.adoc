...
== Sort existing list of persons by name: `sort name`

Sorts the exisiting list of persons in the address book by name.
Format: `sort name`

== Sort existing list of persons by phone number: `sort phone`

Sorts the existing list of persons in the address book by phone number.
Format: `sort phone`
