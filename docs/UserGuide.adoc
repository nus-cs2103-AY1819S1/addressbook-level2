...
== Importing an existing addressbook : `import`

Imports an existing address book into the current address book. +
Format: `import FILE_NAME.txt`

****
Inserts all entries from the specified address book, to the current address book. The current Address Book is referring to the one you are in on start up.
****

Examples:

* `import existing_ab.txt` +
