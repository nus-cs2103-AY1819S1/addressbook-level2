...
Edits a particular field of the specified person from the address book. +
Format: `edit INDEX FIELD/VALUE`

****
Edits a particular `FIELD` with specified `VALUE` of the person at the specified `INDEX`.
The index refers to the index number shown in the most recent listing.
****

[NOTE]
====
The edit command is only able to edit one field at a time. Fields that can be edited are address, email
and phone.
====
...
`edit 3 a/123, Alpha street` +
Edits the address of the 3rd person in the address book. +
`edit 1 e/hello@abc.com` +
Edits the email of the 1st person in the address book.
