...
== Counts number of entries: `total`

Counts and returns the number of entries in the address book. +
Format: `total`

* For example, if there are currently 0 entries in the address book, `total` gives a value of `0`.
* If there are currently 5 entries in the address book, `total` gives a value of `5`.
