...
== Sorted display of all persons : `sort`

Shows a sorted list of all persons, along with their non-private details, in the address book. This only displays, but not affect the actual address book sorting. +
Format: `sort`
