...
== Finding all persons with any phone number: `findPhone`

Finds persons whose phone number matches the phone number(s) specified. +
Format: `findPhone PHONE_NUMBER [MORE_PHONE_NUMBERS]`

[NOTE]
====
The phone number need not be non-private for findPhone to return the matching person.
====
...
* `findPhone 88888888 98765432` +
Returns Any person having the phone numbers `88888888` or `98765432`.
