...
== Setting a person's tags: `settags`

Sets the tags of the specified person. +
Format: `settags INDEX [t/TAG]...`

****
The new set of tags can be any number (including 0).
****

Examples:

* `settags 1 t/evil t/handsome`
* `settags 2 t/criminal t/friend`
* 'settags 3'
