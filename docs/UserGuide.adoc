...
* Edit details of a person (`edit` INDEX n/NAME [p]p/PHONE [p]e/EMAIL [p]a/ADDRESS [t/TAG]... :
        updates details of person at indicated index
...
Format: `edit INDEX n/NAME [p]p/PHONE [p]e/EMAIL [p]a/ADDRESS [t/TAG]...`
...
* `list` +
`edit 2 n/John Doe p/98765543 e/doe@gmail.com a/AngMoKio t/bestfriend` +
Edits the 2nd person in the address book with specified details.
