...
* Sort address book alphabetically by contacts' names (`sort`: sorts the address book)
...
Sorts address book alphabetically by person's name, then lists all of them along with their
non-private details. +
Format: `list`
