...
Finds all persons with email matching the specified email(s) +
Format: `searchEmail EMAIL [ADDITIONAL_EMAILS]`

Examples:

* `searchEmail johnd@gmail.com` +
Returns `John Doe`.

* `searchEmail adam@gmail.com johnd@gmail.com` +
Returns persons having the emails `adam@gmail.com` or `johnd@gmail.com`.
