...
Tags the specified person from the address book with a given tag. Irreversible. +
Format: `tag INDEX TAG`

****
Tags the person at the specified `INDEX` with the specified `TAG`.
...
* `list` +
`tag 2 friend` +
Tags the 2nd person in the address book as a friend.

* `find Betsy` +
`tag 1 boss` +
Deletes the 1st person in the results of the `find` command as a boss.
