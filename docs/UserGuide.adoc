...
Adds a person to the address book. Then, lists all contacts in the address book.+
...
Deletes the specified person from the address book. Irreversible. Then, lists all contacts in the address book.+
Format: `delete INDEX`
