...
== Enchancement from level 2

What's different from AddressBook-Level2:

* add a sort function to sort the person in address book by name

== sorts all persons by name : `sort`

sort all of the persons in address book by name. +
Format: `sort`
...
* `sort` +
`list` +
Views all details of the person in the address book sorted by name.
