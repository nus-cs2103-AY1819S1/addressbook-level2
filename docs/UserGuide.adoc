...
Format: `list` +
Shows a list of persons from a specific page, along with their non-private details, in the address book. +
Format: `list [PAGE_NUMBER]`
[NOTE]
====
If an invalid page number is provided, e.g. -1 or 10000, list will list out all persons in the address book.
Currently a page can only hold 3 persons.
====

== Counting all persons: `count`

Shows the number of all persons in the address book. +
Format: `count`
