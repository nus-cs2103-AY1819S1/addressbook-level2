...
=== Creating a backup of data : `backup`

Backup the data in current addressbook into another file.
Format: `backup`

=== Importing a backup : `import`

Import data from backup and merges with existing addressbook.
Format: `import`
