...
== Sorting all persons by name in alphabetical order : `sort`

Shows a list of all persons, along with their non-private details, sorted by name in alphabetical order. +
Format: `sort`
