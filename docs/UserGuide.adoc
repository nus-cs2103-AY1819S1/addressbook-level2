...
== Listing all persons alphabetically by name : `sort`

Shows a list of all persons, along with their non-private details, in the address book alphabetically by name. +
Format: `list`
