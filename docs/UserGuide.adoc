...
== Finding all persons containing any keyword in their not private fields: `find`

Finds persons whose any not private fields contain any of the given keywords. +
Format: `find KEYWORD [MORE_KEYWORDS]`

[NOTE]
====
The search is case sensitive, the order of the keywords does not matter, all the not private fields is searched,
