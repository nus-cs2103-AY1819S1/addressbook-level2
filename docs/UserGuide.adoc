...
Updates the specified person and changes his/her name.
Format: `update INDEX NEW_NAME`

****
Updates the name of the person at the specified `INDEX` with `NEW_NAME`.
...
* `list` +
`update 2 John` +
Updates the name of the 2nd person to John.

* `find Betsy` +
`update 1 Betty` +
Updates the name of the 1st person in the results of the `find` command to Betty.
