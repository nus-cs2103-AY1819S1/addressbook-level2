...
[NOTE]
====
The search is case insensitive, if the searching keywords are entered in all capital case, +
all lower case or one capital case letter and the rest letters in lower case. +
...
Sorts the persons list according to their first name. +
Format: `sort`
