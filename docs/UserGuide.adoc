...
Adds a person to the address book and show the latest list of persons in the address book. +
...
== Sort all persons inside the address book : `sort`

Sorts all persons in the address book and shows a sorted list. +
Format: `sort`
...
Deletes the specified person from the address book and show the latest list of persons in the address book. Irreversible. +
Format: `delete INDEX`
