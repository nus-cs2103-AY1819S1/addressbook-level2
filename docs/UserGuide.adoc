...
== Finding all persons containing phone numbers that user input: `findPhoneNumber`

Finds persons whose names contain any of the given keywords. +
Format: `findPhoneNumber KEYWORD [MORE_KEYWORDS]`
...
* `findPhoneNumber 12345678`
Returns `John Doe Phone: 98765432 Email: johnd@gmail.com Address: 311, Clementi Ave 2, #02-25 Tags: [owesMoney][friends]`.

* `findPhoneNumber 98765432 99065432`
Returns '1. John Doe Phone: 98765432 Email: johnd@gmail.com Address: 311, Clementi Ave 2, #02-25 Tags: [owesMoney][friends]
         2. Jason Van Phone: 99065432 Email: johnd@gmail.com Address: 311, Clementi Ave 2, #02-25 Tags: [owesMoney][friends]'
