...
== Finding all persons containing the exact keyword in their email address: `find_email`

Finds persons whose email addresses exactly matches the given keywords. +
Format: `find KEYWORD [MORE_KEYWORDS]`
...
* `find_email test@example.com` +
Returns person with email address `test@example.com`

* `find test@example.com tim@hotmail.com john@gmail.com` +
Returns Any person having emails `test@example.com`, `tim@hotmail.com`, or `john@gmail.com`.
