...
Sorts the address book based on a specified field of the person. +
Format: `sort FIELD`

****
Sorts the address book based on the specified field `FIELD`.
The field can be any of these: `name|email|phone`.
****

Examples:

* `sort email` +
Sorts all entries in the address book by email.

* `sort name` +
Sorts all entries in the address book by name.
