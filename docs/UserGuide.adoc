...
****
Edits the person at the specified `INDEX`, and needs whole new information of the person(same as `add`, except `NAME`).
Person will change his index to the last index.
****

Examples:

* `edit 1 p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01`
* `edit 2 pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend`
